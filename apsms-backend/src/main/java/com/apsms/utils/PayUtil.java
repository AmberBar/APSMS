package com.apsms.utils;

import java.util.HashMap;
import java.util.Map;
import java.util.UUID;

import com.apsms.modal.ayspay.PaySaPi;
...
public class PayUtil {
    ...
    public static String UID = "72849e288d352113ff4e2e66";
    ...
    public static String TOKEN = "7e6794b4236b4dd498a2f02007d60cf7";
